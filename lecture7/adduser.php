    ...
    <script>
        ...
        function validatePassword(field) {
            if (field == "") return "No Password was entered.\n";
                ...
                return "Passwords require one each of a-z, A-Z, 0-9.\n"
            return ""
        }
...
<body>
    <table class="signup" border="0" cellpadding="2" cellspacing="5" bgcolor="#eee">
        ...
        <tr>
            <td colspan="2">
                ...
                in your form:
                <p>
                    <font color="red" size="1"><i>$fail</i></font>
                </p>
            </td>
        </tr>
        <form method="post" action="adduser.php" onsubmit="return validate(this)">
            <tr>
                <td>Forename</td>
                <td>
                    <input type="text" maxlength="32" name="forename">
                </td>
            </tr>
            <tr>
                <td>Surname</td>
